...
function joinRoom() {
  ...
  var abortIfOccupied = document.getElementById("abortIfOccupied").checked;
  goToRoom(
...
function genRoomName() {
  ...
  const gon = gons[Math.floor(Math.random() * gons.length)];
  const roomName = capitalize(color) + capitalize(gon);
